---
title: "Understanding H5ParcellatedScan and H5ParcellatedScanSummary"
author: "fmristore Package"
date: "`r Sys.Date()`"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Understanding H5ParcellatedScan and H5ParcellatedScanSummary}
...
1. **H5ParcellatedScan**: Stores complete time series for every voxel
2. **H5ParcellatedScanSummary**: Stores only averaged time series per cluster
...
## H5ParcellatedScan: Full Voxel Data

### When to Use

Use `H5ParcellatedScan` when you need:
...
## H5ParcellatedScanSummary: Averaged Data

### When to Use

Use `H5ParcellatedScanSummary` when you need:
...
### Choose H5ParcellatedScanSummary when:
...
1. **H5ParcellatedScan** = Full resolution, larger storage
2. **H5ParcellatedScanSummary** = Regional averages, compact storage
3. Both can coexist in the same H5ParcellatedMultiScan
...
- See `vignette("H5ParcellatedMultiScan")` for working with multiple runs
