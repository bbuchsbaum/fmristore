  ...
  switch(type,
    ...
    "LatentNeuroVec" = {
      ...
      mask <- if (exists_in_h5(h5, "/mask")) {
        ...
        neuroim2::LogicalNeuroVol(mask_array, 
...
setMethod("read_dataset",
  ...
  function(x, type = NULL, ...) {
    ...
    if (detected_type == "unknown") {
      stop("Cannot determine dataset type for file: ", x, 
...
setMethod("read_dataset",
  ...
  function(x, type = NULL, ...) {
    ...
    if (detected_type == "unknown") {
      stop("Cannot determine dataset type from H5File object",
